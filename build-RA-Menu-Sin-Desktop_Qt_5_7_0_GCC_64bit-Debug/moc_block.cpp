...
QT_MOC_LITERAL(4, 24, 6), // "Block*"
QT_MOC_LITERAL(5, 31, 5) // "block"

    },
    "Block\0clicked\0\0released\0Block*\0block"
};
...
void Block::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->released((*reinterpret_cast< Block*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Block::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Block::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Block::released)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Block::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Block.data,
